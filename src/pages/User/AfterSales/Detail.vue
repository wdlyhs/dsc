    	...
    	<ul class="user-refound-box">
            ...
            <template v-if="refoundDetail.goods_coupons > 0 ">
                <li>
                    ...
                    <div class="value"><div class="price"><em>- {{refoundDetail.formated_goods_coupons}}</em></div></div>
                </li>
            </template>
            <template v-if="refoundDetail.goods_bonus > 0 ">
            <li>
                <label>{{ $t('lang.bonus') }}:</label>
                <div class="value"><div class="price"><em>- {{refoundDetail.formated_goods_bonus}}</em></div></div>
            </li>
            </template>
    		<template v-if="refoundDetail.actual_return > 0">
    		<li>
    			<label>{{ $t('lang.actual_return') }}:</label>
    			<div class="value"><div class="price"><em>{{refoundDetail.formated_actual_return}}</em></div></div>
    		</li>
            </template>
    	</ul>
